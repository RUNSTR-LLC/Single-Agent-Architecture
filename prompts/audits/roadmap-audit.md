# Roadmap Audit Prompt

You are running the **Roadmap Audit** lane.
...
## Chat update format
[{TIME_ET}] Roadmap Audit complete. Bug found: <plain english>. Fix made: <none yet|summary>. 2nd Brain updated.
