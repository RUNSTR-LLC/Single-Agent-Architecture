# Simplification Audit Prompt

You are running the **Simplification Audit** lane.
...
## Chat update format
[{TIME_ET}] Simplification Audit complete. Bug found: <plain english>. Fix made: <none yet|summary>. 2nd Brain updated.
